...
### Pass 8: Literary Critical Panel

Run three independent critical lenses and record disagreements instead of averaging them away.

- Line critic: sentence music, precision, cliche, texture, and image pressure
- Structural critic: architecture, causality, chapter necessity, escalation, and payoff
- Human critic: lived contradiction, embarrassment, pettiness, bodily reality, moral ambiguity, and emotional residue

For each lens, identify:

- the strongest passage and why it works
- the weakest passage and why it fails
- the most obvious sign of generated or over-managed prose
- the one revision that would raise the book's literary ceiling most
...
- if the Literary Critical Panel estimates any lens below 8.5, Phase 5 must run before final scoring
