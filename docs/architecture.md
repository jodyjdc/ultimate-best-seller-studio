...
> Current note: the default workflow for new projects is now the Universal Book Genesis Core (`skills/book-genesis-core/`). This document remains the legacy V4/V5 architecture reference. See `docs/book-genesis-core.md` for the portable agent pipeline.
